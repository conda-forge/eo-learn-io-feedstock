...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eo-learn-io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8655&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eo-learn-io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eo-learn-io` can be installed with:

```
conda install eo-learn-io
```

It is possible to list all of the versions of `eo-learn-io` available on your platform with:
